...
single_folder = "./03_20_2019"
double_folder = "./03_24_2019"
...
##    coords_svm.sort(axis=0)
    
    if i == 0:
##        print("coords is: ", coords)
##        print("coords svm shape 0 is: ", coords_svm)
        break
##    print("sorted coords are: ", coords) 
        # show the image 
##    print("real coords name are: ", read_coords)
##    print("size of cnts is: ", size)
##    
##    cv2.imshow("Image", img)
##    cv2.waitKey(0)

##single_image_coords_calculated = get_contour_centroids(single_image_names,50)
##print("single_image_coords_calculated length is: ", single_image_coords_calculated[0:3])
##    sift = cv2.SIFT()
